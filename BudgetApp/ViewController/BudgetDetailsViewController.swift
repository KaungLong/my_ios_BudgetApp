...
//    }
    ...
    private func deleteTransaction(_ transaction: Transaction) {
        ...
        do {
            ...
            errorMessageLabel.text = "Unable to delete transcation."
        }
    }
    ...
    private func saveTransaction() {
        ...
        //budgetCategory.addToTranscations(transcation)
        ...
        do{
            ...
            errorMessageLabel.text = "Unable to save transcation."
        }
    ...
    @objc func saveTransactionButtonPressed(_ sender:UIButton){
        ...
        if isFormVaild {
            ...
            errorMessageLabel.text = "Make sure name and amount is vaild."
        }
